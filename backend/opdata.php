<?php
 ...
 DATE_FORMAT(month1.date_visit, '%Y-%m-%d') as  MONTHSTART,
DATE_FORMAT(month2.date_visit, '%Y-%m-%d') as  MONTHEND,
...
OR temp_opd.PROVIDER_CODE_ALL LIKE '%5%' or temp_opd.PROVIDER_CODE_ALL is null THEN pid end) as DOCTORANDNURSE,
